...
while k == 0:
	...
	if t == '1':
		var = raw_input('Target: ')
	if t == '2':
		params = raw_input('Target (E.g. https://10.10.10.10:10250/): ')
		cmd3 = 'curl -sk '+params+'runningpods/ | python -mjson.tool'
		os.system(cmd3)
		params1 = raw_input('Select Namespace: ')
		params2 = raw_input('Select Pod: ')
		params3 = raw_input('Select Container: ')
